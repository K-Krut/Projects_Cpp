...
/*
Об’єкти obj temp створюються за допомогою звичайного конструктора, 
але у функція obj = obj.f(); повертає об’єкт temp, 
тому генерується тимчасовий об’єкт, який викликає конструктор копіювання.
*/
